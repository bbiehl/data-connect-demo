import { CreateMovieData, CreateMovieVariables, UpsertUserData, UpsertUserVariables, UpsertReviewData, UpsertReviewVariables, DeleteReviewData, DeleteReviewVariables, ListMoviesData, ListUsersData, GetUserByIdData, GetUserByIdVariables, ListUserReviewsData, GetMovieByIdData, GetMovieByIdVariables, SearchMovieData, SearchMovieVariables } from '../';
...
type GetUserByIdArgs = GetUserByIdVariables | (() => GetUserByIdVariables);
export type GetUserByIdOptions = () => Omit<CreateDataConnectQueryOptions<GetUserByIdData, GetUserByIdVariables>, 'queryFn'>;
export function injectGetUserById(args: GetUserByIdArgs, options?: GetUserByIdOptions, injector?: Injector): CreateDataConnectQueryResult<GetUserByIdData, GetUserByIdVariables>;
