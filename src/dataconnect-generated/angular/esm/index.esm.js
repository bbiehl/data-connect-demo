import { createMovieRef, upsertUserRef, upsertReviewRef, deleteReviewRef, listMoviesRef, listUsersRef, getUserByIdRef, listUserReviewsRef, getMovieByIdRef, searchMovieRef } from '../../';
...
export function injectGetUserById(args, options, injector) {
  const finalInjector = injector || inject(EnvironmentInjector);
  const dc = finalInjector.get(DataConnect);
